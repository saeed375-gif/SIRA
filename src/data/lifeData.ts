...
export const LIFE_STORIES: LifeStory[] = [
  ...
  { ...base, id: 'market-sound', contentType: 'audio', category: 'sound', placeId: 'p-2',
    title: 'استمع إلى حكاية السوق', summary: 'سرد عربي قصير يأخذك بين خطوات خان الزيت وروائح البن والهيل ونداءات الباعة.',
    body: 'تسجيل سردي مولّد بالذكاء الاصطناعي من نص سيرة عن الحياة اليومية في سوق خان الزيت. ليس تسجيلًا ميدانيًا ولا ينسب الكلام إلى بائع أو شخص بعينه.',
    image: photo('khan-al-zait-spices'), imageAlt: 'تفاصيل المعروضات في سوق خان الزيت',
    audioUrl: '/audio/places/khan-al-zait-market.mp3', audioDurationSeconds: 32,
    audioTranscript: 'أغمض عينيك لحظة، وتخيّل أنك تدخل سوق خان الزيت من باب العمود. يتبدّل صدى الخطوات تحت العقود الحجرية، وتصل رائحة البن والهيل والزعتر من الدكاكين. ينادي الباعة على بضائعهم، تمر عربة صغيرة، ويتبادل الجيران السلام. هذا السوق ليس ممرًا للشراء فقط؛ إنه ذاكرة يومية للقدس، تحفظ أصوات الناس وعاداتهم وحكاياتهم بين الحجر والضوء.' },
