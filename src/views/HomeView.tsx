                ...
                <div className="p-5 flex-1 flex flex-col justify-between text-right space-y-3">
                  ...
                  <div className="pt-3 border-t border-[#271A4E] flex items-center justify-between gap-2">
                    ...
                    <button
                      ...
                      className="inline-flex items-center gap-1 px-3.5 py-1.5 rounded-xl bg-[#23164F] hover:bg-[#D4AF37] text-[#FAF8F5] hover:text-[#110B29] text-xs font-bold transition-all border border-[#3C2975] hover:border-[#D4AF37]"
                    >
