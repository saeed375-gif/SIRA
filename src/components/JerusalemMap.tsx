...
export const JerusalemMap: React.FC<JerusalemMapProps> = ({
  ...
  return (
    <div className={`relative overflow-hidden rounded-2xl border border-[#2B1E55] bg-[#110B29] ${className}`}>
      ...
      {/* Loading Overlay */}
      {!mapLoaded && !loadError && (
        <div className="absolute inset-0 z-10 flex flex-col items-center justify-center bg-[#110B29]/90 backdrop-blur-md text-[#FAF8F5]">
      ...
      {loadError && (
        <div className="absolute inset-0 z-20 flex flex-col items-center justify-center p-6 text-center bg-[#140E36] text-[#FAF8F5]">
